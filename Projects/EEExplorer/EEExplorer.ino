...
{
  Serial.println( "" );
  Serial.println( "EEExplorer v001  Scott Lawrence  yorgle@gmail.com" );
  Serial.println( "" );
  Serial.print( " Flash size: " ); Serial.print( FLASHEND +1 ); Serial.println( " bytes" );
